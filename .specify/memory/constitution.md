...
Bump rationale: MINOR. One additive governance rule (2026-07-10, feature 009), no principle removed
...
Templates / artifacts reviewed:
  ...
  ⚠ packages/ui/src/renderer/preferences/  — KNOWN VIOLATIONS at time of amendment: preferences-app.tsx
       ...
       (text-labelled .prefs-toolbtn controls). Remediated by feature 009's theme-editor spec; the rule is
       enforced from that feature forward.
Deferred TODOs: none.
