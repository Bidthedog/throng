...
/**
 * 045 FR-032 — what Copy Link to Clipboard puts on the clipboard (T082).
 *
 ...
 *
 * 044's copy item refuses a target outside the project, because a preview link that leaves
...
describe('Copy Link to Clipboard (FR-032)', () => {
