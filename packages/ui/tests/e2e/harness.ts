...
function startDaemon(
   ...
   * the error.
   */
  // Budget from the module-level DAEMON_READY_TIMEOUT_MS below. A local copy here would be the
  // tenth spelling of one wait, which is the duplication that constant's own docblock exists to end.
