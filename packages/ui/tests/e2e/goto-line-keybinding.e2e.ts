...
test('Go To Line is listed in Preferences → Key Bindings, is rebindable, and after the rebind the NEW chord works while the OLD one stops (AS-10, SC-012, P1)', { tag: ['@extended', '@editor', '@reserve:input'] }, async () => {
