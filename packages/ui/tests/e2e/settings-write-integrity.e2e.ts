...
test('a Preferences change survives a project created in the main window (FR-001, #249)', { tag: ['@extended', '@prefs', '@reserve:window'] }, async () => {
 ...
 */
test('a changed setting is what loads after a restart (FR-006)', { tag: ['@extended', '@prefs', '@reserve:window'] }, async () => {
