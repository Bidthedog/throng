...
export type {
  SerialisedHistory,
  SerialisedUndoEntry,
} from "./editor/undo-persistence.js";
...
} from "./config/product-version.js";
export type {
...
export type {
  PublishGateInput,
  PublishGateResult,
} from "./config/publish-gate.js";
export {
  decideLiveTerminalHandoff,
  resolveLiveTerminalChoice,
...
export type {
  IShellDetection,
  DetectedShell,
} from "./abstractions/shell-detection.js";
...
export type {
  IDirectoryLock,
  LockHandle,
} from "./abstractions/directory-lock.js";
...
export type {
  StartingFolderConfig,
  StartingFolderContext,
} from "./config/starting-folder.js";
export {
...
export {
  ...
  migrateTheme,
  migrateThemeColours,
} from "./config/theme-ops.js";
export { matchFamilies } from "./config/font-typeahead.js";
export type {
  SearchableField,
  SearchableDescriptor,
} from "./config/settings-search.js";
export {
  searchTokens,
  fieldHaystack,
  matchesQuery,
...
export {
  DEFAULT_THEMES,
  ALL_DEFAULT_THEMES,
} from "./config/default-themes/index.js";
export type {
  OnEntrySnapshot,
  WritePlan,
  WritePlanEntry,
} from "./config/theme-reset.js";
export { revertAll } from "./config/theme-reset.js";
...
export type {
  ...
  ThemeRowKind,
  ThemeNameValidation,
} from "./config/theme-editor-model.js";
export {
  classifyThemes,
  validateThemeName,
  cloneName,
...
export type {
  ISubWorkspaceStore,
  SubWorkspaceMeta,
} from "./ports/subworkspace-store.js";
