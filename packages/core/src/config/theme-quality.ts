 ...
 *
 * Re-measured by 045's round four (FR-165g), which added `linkHintBackground`, `linkHintText` and
 * `linkHintBorder` to every theme, each equal to that theme's `surfaceActive`/`text`/`border`
 * respectively: 6.286824864632278 → 6.173849811284115. `warning`'s case again rather than
 * `linkUnderline`'s: these three terms are carved-out roles that already sit close together within a
