...
const osSerial = {
   ...
   *
   * Do NOT buy headroom back by shortening `ping -n 30` in that test. The ping is not a cost the
   * test pays — it is killed by `killAll` long before its 30 seconds elapse, and it exists only
